...
Write-Host -ForegroundColor green -Object 'Configuring the Default ATP policy for Office 365...'
...
Write-Host -ForegroundColor green -Object 'The Anti-Phish Baseline Policy is deployed.'
Write-Host -ForegroundColor green -Object 'ATP baseline configuration has completed.'
