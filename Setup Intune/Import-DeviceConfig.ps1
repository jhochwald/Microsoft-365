...
Function Add-DeviceConfigurationPolicy()
{
   ...
   try 
   {
      ...
      {
         Write-Host -Object 'No JSON specified, please specify valid JSON for the Device Configuration Policy...' -ForegroundColor Red
      }
      else 
      {
         Test-JSON -JSON $JSON
...
Write-Host
Write-Host -Object "Device Configuration Policy '$DisplayName' Found..." -ForegroundColor Yellow
Write-Host

$JSON_Output

Write-Host
Write-Host -Object "Adding Device Configuration Policy '$DisplayName'" -ForegroundColor Yellow
