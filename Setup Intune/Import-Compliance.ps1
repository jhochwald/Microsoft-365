...
Write-Host
Write-Host -Object "Compliance Policy '$DisplayName' Found..." -ForegroundColor Yellow
Write-Host

$JSON_Output

Write-Host
Write-Host -Object "Adding Compliance Policy '$DisplayName'" -ForegroundColor Yellow
